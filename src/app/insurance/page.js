      ...
      <div className='flex '>
        <div className='flex-1 ml-30'>
          ...
          <form className="space-y-4">
            <div>
              <label htmlFor="insure" className="block text-lg font-semibold text-gray-700">Insurance Number</label>
              <input
            ...
            <div>
              <label htmlFor="date" className="block text-lg font-semibold text-gray-700">Expairy Date</label>
              <input
                className="w-auto p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                id="date"
                type="date"
